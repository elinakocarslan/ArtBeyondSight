...
//     try {
//       const existingByUri = await ArtBeyondSightAPI.findByImageUri(imageUri);
...
//         const existingByName = await ArtBeyondSightAPI.findByPaintingName(quickMetadata.paintingName);
